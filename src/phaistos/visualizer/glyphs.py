...
GLYPH_REGISTRY: Dict[str, Dict[str, str]] = {
    ...
    "20": {
        "name": "DOLIUM",
        "emoji": "🏺",
        "short_name": "Amphora Jar",
        "label": "20 🏺 Dolium",
        "unicode_char": "𐇣",
        "unicode_hex": "0x101E3",
        "vector_svg": '<path d="M10 6h12l2 12-4 8h-8l-4-8z" fill="none" stroke="currentColor" stroke-width="2"/><path d="M8 10c-3 0-3 6 0 6M24 10c3 0 3 6 0 6" fill="none" stroke="currentColor" stroke-width="1.8"/>',
    },
    "21": {
        "name": "COMB",
        "emoji": "🪮",
        "short_name": "Comb Facade",
        "label": "21 🪮 Comb",
        "unicode_char": "𐇤",
        "unicode_hex": "0x101E4",
    ...
    "23": {
        ...
        "unicode_char": "𐇦",
        "unicode_hex": "0x101E6",
        "vector_svg": '<path d="M8 6h16M10 6v18M22 6v18M6 24h20" stroke="currentColor" stroke-width="2.2" fill="none" stroke-linecap="round"/>',
    },
    "24": {
        "name": "BEEHIVE",
        "emoji": "🛖",
        "short_name": "Beehive Shrine",
        "label": "24 🛖 Beehive",
        "unicode_char": "𐇧",
        "unicode_hex": "0x101E7",
        "vector_svg": '<path d="M8 26h16c0-10-3-18-8-18s-8 8-8 18z" fill="none" stroke="currentColor" stroke-width="2"/><path d="M11 16h10M9 21h14" stroke="currentColor" stroke-width="1.8"/>',
    },
    "25": {
        "name": "SHIP",
        "emoji": "⛵",
        "short_name": "Sailing Ship",
        "label": "25 ⛵ Ship",
        "unicode_char": "𐇨",
        "unicode_hex": "0x101E8",
    ...
    "40": {
        ...
        "unicode_char": "𐇷",
        "unicode_hex": "0x101F7",
        "vector_svg": '<path d="M6 18c3-6 8-8 12-4s5 8 8 4" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/>',
    },
    "41": {
        "name": "FLUTE",
        "emoji": "🦴",
        "short_name": "Bone Flute",
        "label": "41 🦴 Flute",
        "unicode_char": "𐇸",
        "unicode_hex": "0x101F8",
        "vector_svg": '<path d="M8 24l16-16" stroke="currentColor" stroke-width="3" stroke-linecap="round"/><circle cx="12" cy="20" r="1" fill="currentColor"/><circle cx="16" cy="16" r="1" fill="currentColor"/><circle cx="20" cy="12" r="1" fill="currentColor"/>',
    },
    "42": {
        "name": "GRATER",
        "emoji": "🥢",

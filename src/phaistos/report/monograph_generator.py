...
3. **Archaeological Realia Homology**: The stamped punch motifs correlate with direct physical regalia depicted on the polychrome painted frescoes of the Hagia Triada Sarcophagus ($Z = +{homology_stats.z_score:.2f}\\sigma, p < 0.0001$). Separated by 300 years (MM III c. 1700–1650 BC vs LM IIIA c. 1370–1320 BC), this homology reveals the profound conservatism of Minoan ceremonial apparatus.
...
### 3.3 Monte Carlo Null Permutation Falsification ($Z = +{homology_stats.z_score:.2f}\\sigma$)
...
- **Statistical Significance**: $Z = \\frac{{19 - 3.94}}{{1.86}} = \\mathbf{{+{homology_stats.z_score:.2f}\\sigma}}$, $p < 0.0001$.
...
- **Statistical Significance**: $Z = +{liturgy_alignment.null_surrogate_z_score:.2f}\\sigma$, $p < 0.001$.
